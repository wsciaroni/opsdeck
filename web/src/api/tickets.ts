...
export async function updateTicket(id: string, data: { status_id?: string; priority_id?: string; sensitive?: boolean; assignee_id?: string | null; assignee_custom_name?: string }): Promise<Ticket> {
